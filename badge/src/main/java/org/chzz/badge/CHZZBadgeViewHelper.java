 ...
 * 描述:
 */
public class CHZZBadgeViewHelper {
    private Bitmap mBitmap;
    private CHZZBadgeable mBadgeable;
     ...
     * 拖动时的徽章控件
     */
    private CHZZDragBadgeView mDropBadgeView;
    /**
     * 是否正在拖动
     */
    private boolean mIsDraging;
    /**
     * 拖动大于CHZZBadgeViewHelper.mMoveHiddenThreshold后抬起手指徽章消失的代理
     */
    private CHZZDragDismissDelegate mDelegage;
    private boolean mIsShowDrawable = false;

    public CHZZBadgeViewHelper(CHZZBadgeable badgeable, Context context, AttributeSet attrs, BadgeGravity defaultBadgeGravity) {
        mBadgeable = badgeable;
        initDefaultAttrs(context, defaultBadgeGravity);
        initCustomAttrs(context, attrs);
        afterInitDefaultAndCustomAttrs();
        mDropBadgeView = new CHZZDragBadgeView(context, this);
    }
    ...
    private void initDefaultAttrs(Context context, BadgeGravity defaultBadgeGravity) {
        ...
        mBadgeTextSize = CHZZBadgeViewUtil.sp2px(context, 10);
        ...
        mBadgePadding = CHZZBadgeViewUtil.dp2px(context, 4);
        mBadgeVerticalMargin = CHZZBadgeViewUtil.dp2px(context, 4);
        mBadgeHorizontalMargin = CHZZBadgeViewUtil.dp2px(context, 4);
        ...
        mDragExtra = CHZZBadgeViewUtil.dp2px(context, 4);
        mBadgeDragExtraRectF = new RectF();
    }

    private void initCustomAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CHZZBadgeView);
    ...
    public void setBadgeTextSizeSp(int badgetextSize) {
        if (badgetextSize >= 0) {
            mBadgeTextSize = CHZZBadgeViewUtil.sp2px(mBadgeable.getContext(), badgetextSize);
            mBadgePaint.setTextSize(mBadgeTextSize);
            mBadgeable.postInvalidate();
        }
    }
    ...
    public void setBadgeVerticalMarginDp(int badgeVerticalMargin) {
        if (badgeVerticalMargin >= 0) {
            mBadgeVerticalMargin = CHZZBadgeViewUtil.dp2px(mBadgeable.getContext(), badgeVerticalMargin);
            mBadgeable.postInvalidate();
        }
    }
    ...
    public void setBadgeHorizontalMarginDp(int badgeHorizontalMargin) {
        if (badgeHorizontalMargin >= 0) {
            mBadgeHorizontalMargin = CHZZBadgeViewUtil.dp2px(mBadgeable.getContext(), badgeHorizontalMargin);
            mBadgeable.postInvalidate();
        }
    }
    ...
    public void setBadgePaddingDp(int badgePadding) {
        if (badgePadding >= 0) {
            mBadgePadding = CHZZBadgeViewUtil.dp2px(mBadgeable.getContext(), badgePadding);
            mBadgeable.postInvalidate();
        }
    }
    ...
    public void setBadgeBorderWidthDp(int badgeBorderWidthDp) {
        if (badgeBorderWidthDp >= 0) {
            mBadgeBorderWidth = CHZZBadgeViewUtil.dp2px(mBadgeable.getContext(), badgeBorderWidthDp);
            mBadgeable.postInvalidate();
        }
    }
    ...
    public void setDragDismissDelegage(CHZZDragDismissDelegate delegage) {
        mDelegage = delegage;
    }
